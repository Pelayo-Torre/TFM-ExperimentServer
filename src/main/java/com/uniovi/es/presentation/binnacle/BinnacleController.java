...
public interface BinnacleController {
	 ...
	 * @throws BinnacleException, en caso de que los datos de la nota sean incorrectos
	 ...
	 * @throws BinnacleException en caso de que la nota que se pasa como parámetro no exista en el sistema
	 */
